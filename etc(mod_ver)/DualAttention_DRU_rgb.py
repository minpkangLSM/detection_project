...
if __name__ == "__main__":
    ...
    DA_DRU = DA_DeepResUNet(input_shape=INPUT_SHAPE, lr=LR, num_classes=NUM_CLASSES)
    model = DA_DRU.build_net()
    model.load_weights("./ensemble/dual_attention/m15/da_dru_ensemble_m15_43.hdf5")
    model.summary()
    ...
    # callbacks = [
    #     tf.keras.callbacks.ModelCheckpoint(filepath="./ensemble/dual_attention/m15/da_dru_ensemble_m15_{epoch:02d}.hdf5"),
    #     # tf.keras.callbacks.TensorBoard(log_dir="./DRU_DA_rgb_callbacks/finetune_logs", update_freq="batch"),
    #     # VISUALIZE
