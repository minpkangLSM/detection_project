...
class DeepResUNet :
    ...
    def __init__(self, input_size, lr, num_classes, weight_decay):
    ...
    def build_net(self):
        ...
        weighted_softmax = multiply([weight_map_ip, log_activation])
...
if __name__ == "__main__" :
    ...
    image_generator = image_datagen.flow_from_directory(
       directory="./solarpanel/train/image",
       class_mode=None,
       seed=seed,
       shuffle=True,
       target_size=(512, 512),
    ...
    weight_generator = weight_datagen.flow_from_directory(
        directory="./solarpanel/train/weight",
        class_mode=None,
        seed=seed,
        shuffle=True,
        target_size=(512, 512),
    ...
    mask_generator = mask_datagen_main.flow_from_directory(
       directory="./solarpanel/train/label",
       class_mode=None,
       seed=seed,
       shuffle=True,
       target_size=(512, 512),
    ...
    valid_img_generator = valid_img_datagen.flow_from_directory(
        directory="./solarpanel/valid/image",
        target_size=(512, 512),
        seed=seed,
        shuffle=True,
        class_mode=None,
    ...
    valid_weight_generator = valid_weight_datagen.flow_from_directory(
        directory="./solarpanel/valid/weight",
        target_size=(512, 512),
        seed=seed,
        shuffle=True,
        class_mode=None,
    ...
    valid_mask_generator = valid_msk_datagen.flow_from_directory(
        directory="./solarpanel/valid/label",
        target_size=(512, 512),
        seed=seed,
        shuffle=True,
        class_mode=None,
    ...
    #     directory="./vegetation_set_1/pred",
    #     target_size=(512, 512),
    #     batch_size=1,
    #     shuffle=False,
    #     class_mode=None
    ...
    DeepResUNet = DeepResUNet(input_size=INPUT_SHAPE, lr=LR, num_classes=NUM_CLASSES, weight_decay=WEIGHT_DECAY)
    model = DeepResUNet.build_net()
    model.load_weights("./weighted_DRU/weights/weight_DRU_05.hdf5")
    model.summary()
    ...
    callbacks = [
        tf.keras.callbacks.ModelCheckpoint(filepath="./weighted_DRU/weights/weight_DRU_{epoch:02d}.hdf5"),
        tf.keras.callbacks.TensorBoard(log_dir="./weighted_DRU/log", update_freq="batch"),
        # VISUALIZE
    ...
    model.fit(
        ...
        steps_per_epoch=4*mask_generator.samples/BATCH_SIZE,
        epochs=100,
        callbacks=[callbacks]
    )
