...
def class2color(mask, name):
    ...
    tifi.imwrite("./data_for_sangam_pred/dist3_pred/"+ name+".tif", mask[:, :, 1])
...
def Resblock_bn_DRU_MC_ver(input_tensor, channels, weight_decay = None):
    ...
    batchnorm1 = BatchNormalization()(conv1)
    active1 = Activation(activation="relu")(batchnorm1)
    drp1 = Dropout(rate=0.5, trainable=True)(active1)
    ...
    batchnorm2 = BatchNormalization()(conv2)
    active2 = Activation(activation="relu")(batchnorm2)
    drp2 = Dropout(rate=0.5, trainable=True)(active2)
    ...
    residual = Add()([input_tensor, batchnorm3])
    active3 = Activation(activation="relu")(residual)
    drp3 = Dropout(rate=0.5, trainable=True)(active3)
...
class DeepResUNet :
    ...
    def build_net(self):
        ...
        En_rb5 = Resblock_bn_DRU_MC_ver(En_pool2,
                                        64)
        En_rb6 = Resblock_bn_DRU_MC_ver(En_rb5,
                                        64)
        ...
        # block4 : Resblock x 2
        En_rb7 = Resblock_bn_DRU_MC_ver(En_pool3,
                                        64)
        En_rb8 = Resblock_bn_DRU_MC_ver(En_rb7,
                                        64)
        ...
        De_rb1 = Resblock_bn_DRU_MC_ver(
            De_conv1x1_1,
            64
        )
        De_rb2 = Resblock_bn_DRU_MC_ver(
            De_rb1,
            64
        )
        # block6
        ...
        De_rb3 = Resblock_bn_DRU_MC_ver(
            De_conv1x1_2,
            64
        )
        De_rb4 = Resblock_bn_DRU_MC_ver(
            De_rb3,
            64
        )
        # block7
...
if __name__ == "__main__" :
    ...
    pred_img_generator = pred_img_datagen.flow_from_directory(
        directory="./data_for_sangam_pred/dist3_clipped",
        target_size=(512, 512),
        batch_size=1,
        shuffle=False,
        class_mode=None
    ...
    model.load_weights("./mc_dropout/DRU/weights/dru_mcdropout_92.hdf5")
    model.summary()

    # callbacks = [
    #     # tf.keras.callbacks.ModelCheckpoint(filepath="./mc_dropout/DRU/weights/dru_mcdropout_{epoch:02d}.hdf5"),
    #     # tf.keras.callbacks.TensorBoard(log_dir="./mc_dropout/DRU/logs", update_freq="batch"),
    #     # VISUALIZE
